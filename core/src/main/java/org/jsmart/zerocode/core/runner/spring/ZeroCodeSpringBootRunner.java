package org.jsmart.zerocode.core.runner.spring;
...
public class ZeroCodeSpringBootRunner extends BlockJUnit4ClassRunner {
    private static final Logger LOGGER = LoggerFactory.getLogger(ZeroCodeSpringBootRunner.class);
    ...
    public Injector getMainModuleInjector() {
        ...
        synchronized (this) {
            ////
            final SpringApplication springApplication = testClass.getAnnotation(SpringApplication.class);
            Class<?> cls = springApplication.value();
            Method meth = null;
            try {
                ...
                LOGGER.error("Could not find such method annotated by - '{}'", SpringApplication.class);
