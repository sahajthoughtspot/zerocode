...
public class ZeroCodeJupiterLoadRunner extends ParentRunner<TestMapping> {
    private static final Logger LOGGER = LoggerFactory.getLogger(ZeroCodeJupiterLoadRunner.class);
    ...
    public ZeroCodeJupiterLoadRunner(Class<?> testClass) throws InitializationError {
        super(testClass);
